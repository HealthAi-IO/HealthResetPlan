...
const _privacyPolicyVersion = '2026-09-07-sdk';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '健康重启计划将在你同意并登录后处理必要信息，提供在线健康记录、多端同步和提醒服务。提醒功能在你创建提醒并同意开启后，才会使用通知、精确闹钟、开机恢复以及必要的自启动或关联启动能力，用于发送或恢复你设定的健康提醒。敏感健康数据由服务器加密后存储。云端 AI 功能需要在“我的 - AI 数据处理授权”中另行同意。',
                    style:
