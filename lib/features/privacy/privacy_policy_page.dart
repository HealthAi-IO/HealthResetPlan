...
class PrivacyPolicyPage extends StatelessWidget {
  ...
  static const _sections = [
    ...
    (
      '三、权限与敏感信息说明',
      [
        '健康、病史、用药、体征指标和报告图片属于敏感个人信息。我们仅在你录入、上传、注册登录或开启相关功能时处理。相机和相册仅用于你主动选择的报告、饮食或药品图片；通知、精确闹钟、开机恢复以及必要的自启动或关联启动能力，仅在你主动创建提醒并同意开启后用于今天和明天的健康或用药提醒、设备重启后的提醒恢复和应用更新后的提醒恢复；“同步到手机闹钟”会打开系统时钟，需你在系统界面自行确认。',
