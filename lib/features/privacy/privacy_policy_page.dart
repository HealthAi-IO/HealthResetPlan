...
class PrivacyPolicyPage extends StatelessWidget {
  ...
  static const _sections = [
    ...
    (
      '五、对外提供与第三方',
      [
        '我们不会出售个人信息，也不会向第三方共享、转让或公开披露你的个人信息，法律法规另有规定或取得你单独同意的情形除外。你单独同意云端 AI 后，我们会将完成该次请求所必需的信息提供给你在授权页面确认的 AI 服务商（通义千问）。我们要求其仅按指令处理，不用于广告、用户画像或模型训练。当前市场版不接入广告、统计、推送或社交类第三方数据服务。',
      ],
    ),
    (
      '六、AI 单独同意与撤回',
